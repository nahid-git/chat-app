...
const NotFound = () => {
    return (
        <div>
            <Title props="Not Found"/>
            <div className="w-screen bg-gray-50 flex items-center dark:bg-slate-800 dark:text-slate-400">
                <div className="container flex flex-col md:flex-row items-center justify-between px-5 text-gray-700">
                    <div className="w-full lg:w-1/2 mx-8">
                        ...
                        <p className="text-2xl md:text-3xl font-light leading-normal mb-8 dark:text-slate-400">
